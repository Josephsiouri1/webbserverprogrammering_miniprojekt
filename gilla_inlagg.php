...
<body>
    ...
    $inlagg_id = $_GET['inlagg_id'];
    $anvandernamn = $_SESSION['anvandernamn'];

    $sql_gilla = "SELECT * FROM gilla_inlagg";
    ...
    if (!$redan_gillat) {
        $sql = "INSERT INTO gilla_inlagg (inlagg_id,anvandernamn) VALUES ($inlagg_id,'$anvandernamn')";
        $result = $conn->query($sql);
        echo "Du har gillat tråden med id: $inlagg_id";
    } else {
